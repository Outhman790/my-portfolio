...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
      <div
        className={`mobile-menu fixed top-0 right-0 bottom-0 w-64 bg-background border-l border-border z-50 md:hidden transform transition-transform duration-300 ease-in-out ${
